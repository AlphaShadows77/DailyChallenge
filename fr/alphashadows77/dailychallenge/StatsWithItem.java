...
public enum StatsWithItem {
	...
	AVIATE_ONE_CM(Statistic.AVIATE_ONE_CM, new ItemStack(Material.ELYTRA, 1), Utils.getMessage("stat-aviate_one_cm")),
	...
	SNEAK_TIME(Statistic.SNEAK_TIME, new ItemStack(Material.SOUL_SAND, 1), Utils.getMessage("stat-sneak_time")),
